...
spplot(stack(miami_cropmask<=2.76,miami_cropmask<=5, miami_cropmask<=10.97), main="Flood Risk Area under Three Sea Level Rise Scenarios Plus Storm Surge")

plot_income3 <- ggplot(income_map3,aes(x=long,y=lat,order=order,group=group,fill=HD01_VD01), main="2015 Household Income by Block Group")+geom_polygon()+scale_fill_gradient(low="white",high="darkred",na.value = "grey50",name="Income (USD)")+coord_map()
plot_income3
